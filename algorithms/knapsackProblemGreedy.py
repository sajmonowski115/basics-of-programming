...
def greedySolution(file, size):
    '''sort the list by values of objects and than iterate through the whole list trying
    to pack each element'''
    ...
    #sort the list by the value of subjects
...
def main():
    ...
    greedySolution('packages20.txt', 20)
    greedySolution('packages100.txt', 100)
    greedySolution('packages500.txt', 500)
    greedySolution('packages1000.txt', 1000)
